...
/*
P: param is a ufc fighter

R: return the right statement depending on the winner of the fight

E:  If the winner is George Saint Pierre he will obviously say:
...
P: 1 - create a swtich statement, starting with the param fighter, adding the toLowerCase() function for case-insensitivity
   2 - write case for Conor McGregor
   3 - write case for George Saint Pierre
   4 - write default case
